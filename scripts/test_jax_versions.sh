...
JAX_VERSIONS=("0.6.2" "0.7.0" "0.7.1" "0.7.2" "0.8.0" "0.8.1" "0.8.2" "0.9.0.1" "0.9.1" "0.9.2")
...
do
  ...
  JAXPP_FAST_INFER_SHARDINGS=1 JAXPP_DEBUG_FORCE_MPMDIFY=True JAXPP_ENABLE_LICM=True python examples/basic.py --train_steps=10
done
