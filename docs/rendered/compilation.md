<!-- Generated by the docs build from docs/compilation.md; do not edit. -->
...
```
    ...
    let add_one = { lambda ; a:f32[4]. let
        b:f32[4] = pallas_call[
          ...
          cost_estimate=None
          debug=False
          grid_mapping=GridMapping(grid=(), block_mappings=(BlockMapping(block_shape=(Blocked(block_size=4),)), BlockMapping(block_shape=(Blocked(block_size=4),))))
          ...
          metadata=None
          name=None
          out_avals=(ShapedArray(float32[4]),)
        ] a
      in (b,) } in
